...
public class Parser {
	...
	/**
	 * white is player_1 and identified by int 1
	 */
	public final static int PLAYER_1 = 1;
	/**
	 * black is player_2 and identified by int -1
	 */
	public final static int PLAYER_2 = -1;
	/**
	 * Black team piece types and initial formation
	 */
	public final static char[][] BLACK = {
			{'R','N','B','Q','K','B','N','R'},
			{'p','p','p','p','p','p','p','p'}};
	/**
	 * White team piece types and initial formation
	 */
	public final static char[][] WHITE = {
			{'p','p','p','p','p','p','p','p'},
			{'R','N','B','Q','K','B','N','R'}};
	/**
	 * Default promotion type
	 */
	 ...
	 * @param old Pawn instance to be promoted
	 * @return ChessPiece
	 * @author diegocastellanos
	 */
	 ...
	 * @param i position in a gamboard (row)
	 * @param j position in a gamboard (column)
	 * @param p int player 1 or -1
	 * @return ChessPiece
	 * @author diegocastellanos
	 */
	 ...
	 * @param array String[] to be adjusted
	...
	/**
	 * Used to decide if a type is valid for promotion
	 * @param input String
	 * @return boolean 
	 * @author diegocastellanos
	 */
	public static boolean validType(String input) {
		if (input.length() == 1) {
			...
			for(int r = 0; r < BLACK.length; r++) {
				for(int c = 0; c < BLACK[r].length; c++) {			
					if(type == BLACK[r][c]) {
						return true;
					}	
				}
